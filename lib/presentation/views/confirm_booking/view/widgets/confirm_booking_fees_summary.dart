...
class ConfirmBookingFeesSummary extends StatelessWidget {
  final BookingConfirmData confirmData;

  const ConfirmBookingFeesSummary({super.key, required this.confirmData});
        ...
        children: [
          _FeeRow(
            ...
            value: Translation.price_qar
                .trNamed({'price': confirmData.price.subTotal.toString()}),
            isTotal: false,
          ),
          SizedBox(height: 6.h),
          _FeeRow(
            ...
            value: Translation.price_qar
                .trNamed({'price': confirmData.price.feeAmount.toString()}),
            isTotal: false,
          ),
          SizedBox(height: 8.h),
          Container(
